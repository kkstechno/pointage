                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($v->status_timein != '' && $v->status_timeout != '') 
                                            <span class="@if($v->status_timein == 'Late In') red @else blue @endif">{{ __("Retard") }}</span> /  
                                            <span class="@if($v->status_timeout == 'Early Out') orange @else green @endif">{{ __("Départ précoce") }}</span> 
