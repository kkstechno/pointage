@extends('layouts.personal')
    ...
    @section('meta')
        <title>Mes Horaires | KKS-Presence</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
            <h2 class="page-title">{{ __("MES HEURES DE TRAVAIL") }}</h2>
            </div>    
        </div>
            ...
            <div class="box box-success">
                <div class="box-body reportstable">
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" data-order='[[ 6, "desc" ]]'>
                        <thead>
                            <tr>
                                <th>{{ __("Heure de Debut") }}</th>
                                <th>{{ __("Heure de Depart") }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @php 
                                        echo e(date('d-m-Y',strtotime($sched->datefrom)));
                                    @endphp 
                                </td>
                                <td>
                                    @php 
                                        echo e(date('d-m-Y',strtotime($sched->dateto)));
                                    @endphp
                                </td>
                                <td>
                                    @if($sched->archive == '0') 
