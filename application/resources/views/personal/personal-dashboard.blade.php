        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><span class="uppercase" style="color:Green;">{{ __("Pointage (Mois actuel)") }}</span></span>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text" style="color:Red;">{{ __("Mes Horaires") }}</span>
                        <div class="progress-group">
                            <div class="progress sm">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text uppercase" style="color:orange;">{{ __("Mes Congés") }}</span>
                        <div class="progress-group">
                            <div class="progress sm">
                    ...
                    <div class="box-body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-left">{{ __("Heure") }}</th>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="box box-success">
                    ...
                    <table class="table table-striped nobordertop">
                        <thead>
                            <tr>
                                <th class="text-left">{{ __("Temps") }}</th>
                                <th class="text-left">{{ __("À partir de la date / jusqu'au") }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            @isset($ps)
