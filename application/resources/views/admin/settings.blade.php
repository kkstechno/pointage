@extends('layouts.default')
    ...
    @section('meta')
        <title>Réglages | KKS-Presence</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{ __("Principaux Reglages") }}</h2>
            </div>    
        </div>
            ...
            <div class="box box-success">
                <div class="box-body">
                    ...
                    <div class="ui secondary blue pointing tabular menu">
                        <a class="item active" data-tab="system">{{ __("Système") }}</a>
                        <a class="item" data-tab="about">{{ __("A Propos") }}</a>
                    ...
                    <div class="ui tab active" data-tab="system">
                        <div class="col-md-12">
                            <div class="tab-content">
                                    ...
                                    <div class="content">
                                        @csrf
                                            <h4 class="ui dividing header">{{ __("Localisation") }}</h4>

                                            <div class="eight wide field">
                                                <h2 class="ui small header">{{ __("Pays") }}
                                                    <div class="sub header">{{ __("Sélectionnez votre pays pour activer ses fonctionnalités spécifiques.") }}</div>
                                                </h2>
                                            ...
                                            <div class="eight wide field">
                                                <h2 class="ui small header">{{ __("Fuseau Horaire") }}
                                                    <div class="sub header">{{ __("Sélectionnez votre région et votre ville pour synchroniser l'heure de présence") }}</div>
                                                </h2>
                                            ...
                                            <div class="eight wide field">
                                                <h2 class="ui small header">{{ __("Format de l'heure") }}
                                                    <div class="sub header">{{ __("Sélectionnez votre format d'heure préféré") }}</div>
                                                </h2>
                                                <select name="time_format" class="ui dropdown uppercase">
                                                    <option value="">Sélectionner Format</option>
                                                    <option value="1" @isset($data->time_format) @if($data->time_format == 1) selected @endif @endisset>12 H</option>
                                                    <option value="2" @isset($data->time_format) @if($data->time_format == 2) selected @endif @endisset>24 H</option>
                                                </select>
                                            </div>

                                            <h4 class="ui dividing header">{{ __("CARACTÉRISTIQUES OPTIONNELLES") }}</h4>
                                            ...
                                            <div class="eight wide field">
                                                <h2 class="ui small header">{{ __("COMMENTAIRE") }}
                                                    <div class="sub header">{{ __("Activer pour demander un commentaire ou une justifcation lors du pointage.") }}</div>
                                                </h2>
                                                <div class="ui toggle checkbox ">
                                                  <input type="checkbox" name="clock_comment" @isset($data->clock_comment)@if($data->clock_comment == "on") checked @endif @endisset>
                                                  <label>Désactiver/Activer</label>
                                                </div>
                                            </div>
