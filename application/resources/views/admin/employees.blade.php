@extends('layouts.default')
    ...
    @section('meta')
        <title>Employés | KKS-Presence</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title uppercase">{{ __('LISTE DES EMPLOYES') }}
                <a class="ui positive button mini offsettop5 float-right" href="{{ url('employees/new') }}"><i class="ui icon plus"></i>{{ __('Nouvel Employé') }}</a>
            </h2>
        </div>
                ...
                <table width="100%" class="table table-striped table-hover" id="dataTables-example" data-order='[[ 0, "desc" ]]'>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $employee)
                            ...
                            <td>@if($employee->employmentstatus == 'Active') Activé @else Archivé @endif</td>
