@extends('layouts.default')
    ...
    @section('meta')
        <title>Rôles | KKS-Presence</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <h2 class="page-title">{{ __("Les rôles enregistrés") }}
                <button class="ui positive button mini offsettop5 btn-add float-right"><i class="ui icon plus"></i>{{ __("Ajouter") }}</button>
                <a href="{{ url('users') }}" class="ui basic blue button mini offsettop5 float-right"><i class="ui icon chevron left"></i>{{ __("Retour") }}</a>
            </h2>
        </div>
