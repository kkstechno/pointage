@extends('layouts.default')
    ...
    @section('meta')
        <title>Rapport | KKS-Presence</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{ __("Rapport Général") }}
                    <button class="ui basic button mini offsettop5 float-right" id="toggleview"><i class="ui icon columns"></i>{{ __("Voir") }}</button> 
                    <a href="{{ url('reports') }}" class="ui blue basic button mini offsettop5 float-right"><i class="ui icon chevron left"></i>{{ __("Retour") }}</a>
                </h2>
            </div>    
        </div>
        ...
        <div class="row columnview">
            ...
            <div class="col-md-6 colview">
                <div class="box box-success" style="width : 350px; height : 250px;">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ __("Population de l'entreprise") }}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper" size=50%>
